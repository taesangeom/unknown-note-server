...
//            socialId = email; // Google에서는 email을 사용
//        } else {
//            socialId = oAuth2User.getAttribute("id"); // Naver와 Kakao에서는 id를 사용
//        }
//
//        UserEntity existData = userRepository.findByMethodAndSocialId(provider, socialId);
//
//        if (existData == null) {
//            UserEntity userEntity = new UserEntity();
//            userEntity.setMethod(provider);
//            userEntity.setSocialId(socialId);
//            userEntity.setRole("ROLE_USER");
//            userRepository.save(userEntity);
//            UserDTO userDTO = new UserDTO();
//            userDTO.setMethod(provider);
//            userDTO.setSocialId(socialId);
//            userDTO.setRole("ROLE_USER");
//            return new CustomOAuth2User(userDTO);
//        }
//        else {
//            existData.setSocialId(socialId);
//            userRepository.save(existData);
//            UserDTO userDTO = new UserDTO();
//            userDTO.setMethod(existData.getMethod());
